...
import "./Home.css"; // External stylesheet for consistent styling
  ...
  return (
    <div className="home-page">
      ...
      <nav className="navbar">
        ...
        <h2 className="glitter-heading">Personality Insight</h2>
      ...
      <div className="content">
        <h1>Learn to know yourself better with this personality test.</h1>
        <p>The following test contains 60 questions which is estimated to take you about 10 minutes to complete.Don't think twice,choose what you feel first.All the best!</p>
      </div>

      {/* Centered Button Section */}
      <button className="take-test-button" onClick={() => navigate("/quiz")}>Take the Test</button>

      {/* GIF Section */}
      <div className="gif-container">
        <img src="https://i.pinimg.com/originals/a3/0c/00/a30c002d42e53a5c07783fdea4b5c9ff.gif" // Replace this with your direct GIF URL
          alt="Personality Test GIF"
          className="gif-image"
        />
      </div>
